      ...
      >
        ...
        <nav className="flex flex-1 flex-col gap-0.5 px-3 py-4 overflow-y-auto">
          ...
          <div className="mb-3">
            ...
            {enabledModules.includes('monthly-report') && (
              <NavLink to="/report-card" className={navLinkClass} onClick={onClose}>
                <ReportCardIcon />
                כרטיס ציון פיננסי
              </NavLink>
            )}
            {enabledModules.includes('spending-trends') && (
              <NavLink to="/spending-trends" className={navLinkClass} onClick={onClose}>
                <TrendingIcon />
                מגמות הוצאות
              </NavLink>
            )}
