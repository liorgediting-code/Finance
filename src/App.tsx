...
// Lazy-loaded module pages — only downloaded when the user navigates to them
...
function PageLoader() {
  return (
    <div className="flex items-center justify-center py-20" dir="rtl">
      <div className="w-6 h-6 border-2 border-lavender-dark border-t-transparent rounded-full animate-spin" />
    </div>
  )
}
